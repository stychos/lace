...
#include "../../../liblace/include/config/saved_connection.h"
#include <stdbool.h>
#include <stddef.h>
...
/* Saved connection - use liblace type with alias for compatibility */
typedef LaceSavedConnection SavedConnection;
